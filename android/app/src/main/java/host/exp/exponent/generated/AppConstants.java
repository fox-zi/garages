...
public class AppConstants {
  ...
  public static String INITIAL_URL = "exp://exp.host/@foxzi/fix-my-bike";
  public static final boolean IS_DETACHED = true;
  public static final String SHELL_APP_SCHEME = "exp55636b312ab942fba78ce018cf4af5e5";
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
        ...
        embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@foxzi/fix-my-bike/index.exp", "assets://shell-app-manifest.json", "application/json"));
        embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40foxzi%2Ffix-my-bike%2F0.1.0%2Fdab18ba8a16653439f9bee1a655a80f6-27.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
